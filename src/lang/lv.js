...
export default {
  ...
  personal_text:
    "Mani sauc Dāvis un esmu no Latvijas, Līgatnes. Pagaidām dzīvojos pa Nīderlandi kamēr mācos. Man jau no jaunatnes ir paticis čakarēties ar datoriem un risināt gan matemātiskas, gan programmēšanas problēmas.",
  edu: "Izglītība",
  edu_text:
    "Pagaidām esmu maģistra programmā Computer and Embedded Systems Engineering Delft Tehnoloģijas universitātē. Iepriekš es jau absolvēju šeit ar Computer Science grādu, honorāru un Cum Laude. Mācību laikā iemācījos programmatūras principus, datubāzes, testēšanu un pārāk daudz programmēšanas valodas.",
  exp: "Pieredze",
  exp_text:
