    ...
    <div className="header">
      <div className="logo-sec">
        <a href="#intro">
          <img
            className="logo-dk"
            src={props.theme === "dark" ? logo_dark_theme : logo_light_theme}
            alt="logo"
          />
        </a>
      </div>
      ...
      <div className="option-sec">
        <button className="lang-switch rem-2" onClick={props.langTog}>
          {" "}
          {props.lang.lang_switch}{" "}
        </button>
        <img
          className="light-switch"
          onClick={props.themeTog}
          src={props.theme === "dark" ? switch_dark_theme : switch_light_theme}
          alt="light switch"
        />
      </div>
    </div>
