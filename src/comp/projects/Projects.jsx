          ...
          <div className="project-wrapper" >
            ...
            </div>
            {
                item.enable_external_link ?
                  <a href={item.link} rel="noopener noreferrer" target="_blank" className="default-button center-box mrg-top-20"> 
                    {item.link_text}
                  </a>
                  :
                  <div/>
            ...
            {
                item.enable_link ?
                  <Link to={item.link} className="default-button center-box mrg-top-20"> {item.link_text} </Link>
                  :
                  <div/>
            }
