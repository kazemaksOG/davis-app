        ...
        <React.Fragment>
          <div className="restart-button">
            <img
              ...
              src={
                props.theme === "dark" ? dark_theme_replay : light_theme_replay
              }
              onClick={() => restart()}
              alt="restart"
            />
          ...
          <div className="type-writer">
            {props.lang.welcome === "Welcome." ? "" : <Spacer amount={1} />}
            {props.lang.welcome}
          </div>

          <div className="intro-text-1">{props.lang.my_name}</div>

          <div className="intro-text-2">{props.lang.this_is}</div>
